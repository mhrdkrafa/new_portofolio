    ...
    <header className="sticky top-0 z-40 w-full border-b border-white/10 bg-canvas/80 backdrop-blur-md transition-colors">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-12 flex items-center justify-between h-20">
        ...
        <div className="flex items-center space-x-4">
          <Link
            href="/contact"
            className="px-4 py-2 rounded-md bg-white/5 hover:bg-white/10 border border-white/10 hover:border-cyan-400/50 text-xs font-mono font-medium text-white transition-all duration-200"
          >
            Initiate Contact →
          </Link>
        </div>
